...
function module:GetTweenObject(instance, tInfo, propertyTable, inPlace, callback)
	return module:Create(instance, tInfo, propertyTable, inPlace, callback)	
end

function module:Create(instance, tInfo, propertyTable, inPlace, Callback)
	local tweenMaster = {}
